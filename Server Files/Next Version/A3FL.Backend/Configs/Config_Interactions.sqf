...
[
	...
	[
		localize "STR_INTER_CROCHETER",
		{
			...
			if ((typeOf _intersect) IN ["A3PL_Jayhawk","A3PL_Cutter","B_supplyCrate_F","C_IDAP_supplyCrate_F","A3PL_EMS_Locker"]) exitWith {["You cannot lockpick this vehicle", "red"] call A3PL_Player_Notification;};
	...
	[
		...
		{(typeOf (vehicle player) IN ["A3PL_Charger_PD","A3PL_Charger_PD_Slicktop","A3PL_Mustang_PD","A3PL_Mustang_PD_Slicktop","A3PL_CVPI_PD_Slicktop","A3PL_Tahoe_PD","A3PL_Tahoe_PD_Slicktop","A3PL_CVPI_PD","A3PL_Raptor_PD","A3PL_Raptor_PD_ST","A3PL_Taurus_PD","A3PL_Taurus_PD_ST","A3PL_Charger15_PD","A3PL_Charger15_PD_ST","A3PL_Silverado_PD","A3PL_Silverado_PD_ST","A3FL_Explorer_Platinum_PD_20","A3FL_Explorer_Platinum_PD_Slicktop_20"])}
	],
	[
