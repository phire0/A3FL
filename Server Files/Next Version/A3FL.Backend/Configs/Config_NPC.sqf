...
[
	...
	["dmv_drivingteststart","Okay, the test costs $500 and covers some basic road and safety laws. Let me know when you are ready to begin.",["I'm ready!","I'm not ready, I'll be back later"],["if(player getVariable['player_cash',0] < 500) exitWith {['You do not have enough money for the driving test!','red'] call A3PL_Player_Notification;}; if(['driver'] call A3PL_DMV_Check) exitWith {['You already have a driving license!','red'] call A3PL_Player_Notification;}; ['dmv_drivingtest1'] call A3PL_NPC_Start; _cash = player getVariable ['player_cash',0]; player setVariable ['player_cash',(_cash - 500),true];",""]],
