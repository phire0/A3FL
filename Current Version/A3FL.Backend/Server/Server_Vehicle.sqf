...
['Server_Vehicle_Spawn', {
	...
	if (_id IN ["WASTE","MAILMAN","EXTERMINATOR","KARTING","DMV","ROADSIDE"]) then {
		switch (_class) do {
...
["Server_Vehicle_Init_A3PL_Fatboy_PD",{_this call Server_Vehicle_Init_A3PL_Tahoe_PD_Slicktop;},true] call Server_Setup_Compile;
